...
BigNumbers BigNumbers::multiply(BigNumbers const& big)
{
	...
	int indexOne = nums.size() - 1;  /*!<indexOne is the max index for base BigNumbers*/
	int indexTwo = big.nums.size() - 1; /*!<indexTwo is the max index for big BigNumbers*/
	...
	//The code was edited to fit my code and I looked over it and tested it 
	{
		...
		// will keep the result number in a vector 
		// in reverse order 
...
BigNumbers BigNumbers::divide(BigNumbers const& big)
{
	...
	int counter = 0; /*!<Keeps track of how many times the dividen was subtracted */
